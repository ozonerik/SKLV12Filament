...
<head>
    ...
    <style>
        ...
        .footer-note { margin-top: 3px; text-align: justify; text-justify: inter-word;}
        .footer-grid { width: 100%; margin-top: 3px; }
        .footer-grid td { vertical-align: top; }
        .verification-box { width: 180px; font-size: 9px; }
        .verification-qr { width: 58px; height: 58px; }
        ...
        .signature-wrapper { position: relative; height: 2.3cm; margin: 0; overflow: visible; }
        .signature-image {
            position: absolute;
            left: calc(50% - 1.5cm);
            top: 0.05cm;
        ...
        .name-line { font-weight: 700; text-decoration: underline; margin-top: -0.4cm; position: relative; z-index: 1; }
...
<body>
    ...
    <p class="footer-note">
        Surat Keterangan ini <strong>bersifat sementara dan berlaku sampai diterbitkannya ijazah</strong> untuk peserta didik yang bersangkutan.
    ...
    <table class="footer-verification">
        <tr>
            ...
            <td style="padding-left: 8px; padding-top: 12px; vertical-align: top; font-size: 9px;">
                <div>Dokumen digital yang asli dapat diperoleh dengan memindai QR Code, memasukkan kode pada Sistem Informasi Kelulusan {{ $school?->name ?? 'SMK NEGERI' }}, atau mengakses tautan berikut:</div>
